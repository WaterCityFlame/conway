...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__20795__auto__,writer__20796__auto__,opt__20797__auto__){
return cljs.core._write.call(null,writer__20796__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__21871 = o;
(G__21871[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__21873__i < G__21873__a.length) {G__21873__a[G__21873__i] = arguments[G__21873__i + 0]; ++G__21873__i;}
  args = new cljs.core.IndexedSeq(G__21873__a,0);
} 
...
if(cljs.core.truth_((function (){var and__20177__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__20177__auto__){
var and__20177__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__21880 = jsprops;
(G__21880["defaultValue"] = value);

(G__21880["onChange"] = ((function (G__21880,v,value,on_change){
return (function (p1__21877_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21877_SHARP_);
});})(G__21880,v,value,on_change))
);

(G__21880["ref"] = ((function (G__21880,v,value,on_change){
return (function (p1__21878_SHARP_){
return (this$["cljsInputElement"] = p1__21878_SHARP_);
});})(G__21880,v,value,on_change))
);
...
var vec__21887 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21887,(0),null);
var id = cljs.core.nth.call(null,vec__21887,(1),null);
var class$ = cljs.core.nth.call(null,vec__21887,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___21892 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___21892 == null)){
} else {
var key_21893 = temp__4661__auto___21892;
(jsprops["key"] = key_21893);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__21895 = (new reagent.impl.template.NativeWrapper());
(G__21895["name"] = c);
...
var len__21264__auto___21901 = arguments.length;
var i__21265__auto___21902 = (0);
while(true){
if((i__21265__auto___21902 < len__21264__auto___21901)){
args__21271__auto__.push((arguments[i__21265__auto___21902]));

var G__21903 = (i__21265__auto___21902 + (1));
i__21265__auto___21902 = G__21903;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__21272__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21899){
var G__21900 = cljs.core.first.call(null,seq21899);
var seq21899__$1 = cljs.core.next.call(null,seq21899);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__21900,seq21899__$1);
});
...
break;
default:
var G__21907 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__21907;
continue;
...
var n__21104__auto___21910 = a.length;
var i_21911 = (0);
while(true){
if((i_21911 < n__21104__auto___21910)){
(a[i_21911] = reagent.impl.template.as_element.call(null,(a[i_21911])));
...
var a = cljs.core.into_array.call(null,s);
var n__21104__auto___21913 = a.length;
var i_21914 = (0);
while(true){
if((i_21914 < n__21104__auto___21913)){
var val_21915 = (a[i_21914]);
if((cljs.core.vector_QMARK_.call(null,val_21915)) && ((reagent.impl.template.key_from_vec.call(null,val_21915) == null))){
(o["no-key"] = true);
} else {
}

(a[i_21914] = reagent.impl.template.as_element.call(null,val_21915));

var G__21916 = (i_21914 + (1));
i_21914 = G__21916;
continue;
} else {
}
...
var ctx = ({});
var vec__21920 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21920,(0),null);
var derefed = cljs.core.nth.call(null,vec__21920,(1),null);
...
var G__21924 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21924) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__21924){
...
//# sourceMappingURL=template.js.map?rel=1487784997528